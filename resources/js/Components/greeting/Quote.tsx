            ...
            <div className="relative mb-8">
                ...
                <div className="flex flex-col gap-4 bg-color-secondary px-8 text-justify text-sm text-color-primary md:text-base">
                    ...
                    <p className="md:text-lg">
                        Selamat datang di website kami Yayasan Al-Istiqomah
                        Kabupaten Lampung Timur. Website ini hadir sebagai media
                        ...
                        belajar dan mengajar di Yayasan Al-Istiqomah Girimulyo
                        ...
                        bermanfaat bagi seluruh keluarga besar Yayasan
